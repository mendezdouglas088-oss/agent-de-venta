  ...
  return (
    ...
    >
      <div
        ...
        className="w-full max-w-sm rounded-2xl bg-white dark:bg-neutral-900 p-6 text-center shadow-2xl"
      >
        ...
        {connectingAccountId ? (
          ...
          <p className="text-sm text-neutral-500 dark:text-neutral-400">No account selected.</p>
        )}
        {showScanHint && (
